...
INSERT IGNORE INTO users (first_name, last_name, email, password, role, active, created_at)
VALUES ('Admin', 'User', 'admin@blackpearl.com',
        '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVEFDa',
        'ADMIN', TRUE, NOW());

-- Default regular user (password: user123 – BCrypt encoded)
INSERT IGNORE INTO users (first_name, last_name, email, password, department, role, active, created_at)
